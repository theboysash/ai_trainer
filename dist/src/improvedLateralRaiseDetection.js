...
export class ImprovedLateralRaiseDetector {
    ...
    START_THRESHOLD = 15; // Degrees from vertical to start detecting
    TOP_THRESHOLD = 75; // Target top position
    MIN_ROM = 50; // Minimum range of motion for valid rep
    HYSTERESIS = 8; // Prevent oscillation between states
    ...
    computeLateralRaiseMetrics(landmarks) {
    ...
    calculateLateralRaiseAngle(shoulder, elbow, wrist) {
...
//# sourceMappingURL=improvedLateralRaiseDetection.js.map