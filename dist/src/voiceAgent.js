export class VoiceAgent {
    ...
    messageQueue = [];
    lastSpoken = 0;
    MIN_SPEAK_INTERVAL = 3000; // 3 seconds between messages
    ...
    velocityHistory = [];
    setVelocities = []; // Track velocities per set
    lastVLWarning = 0;
    ...
    analyzeStep(stepInfo, setNumber) {
    ...
    checkVelocityLoss(stepInfo, setNumber) {
    ...
    getVelocityLossMessage(vl, threshold, critical) {
